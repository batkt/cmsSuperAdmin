...
import { RecursiveRenderer } from '../engine/RecursiveRenderer'
...
function DraggableComponent({
  ...
  const renderComponent = () => {
    // Check if it's a new engine component
    if (componentRegistry[component.type.toLowerCase()]) {
       return (
         <div style={componentStyle}>
           <RecursiveRenderer
             instance={{
               ...
               children: [] // Will parse actual children if stored in content later
             }}
    ...
    // We use DraggableSection for legacy components that have sections
    ...
    switch (type) {
      ...
      case 'hero':
        base.content = {
          ...
          subtitle: 'Start building something amazing today with our interactive editor.',
          bg: 'slate900',
          align: 'center',
          padding: 'xl',
          buttons: [{ text: 'Get Started', variant: 'primary', size: 'lg' }]
        }
        break
      case 'about':
        base.content = {
          title: 'ABOUT OUR COMPANY',
          description: 'We are dedicated to providing the best web solutions for your business growth and online presence.',
          bg: 'white',
          align: 'left',
          padding: 'lg',
          images: [{ url: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=800&q=80', alt: 'Office' }]
        }
        break
      case 'footer':
        base.content = {
